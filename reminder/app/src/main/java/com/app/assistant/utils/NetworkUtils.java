...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AssistantApplication.getContext().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AssistantApplication.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AssistantApplication.getContext().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AssistantApplication.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AssistantApplication.getContext().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
