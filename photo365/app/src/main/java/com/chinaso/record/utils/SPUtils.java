...
/**
 * author: zhanghe
 * created on: 2018/7/11 14:28
 * description: utils about sharePreference
 */
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = RecordApplication.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = RecordApplication.getContext().getSharedPreferences(spName, mode);
    }
