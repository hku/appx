package com.chinaso.record.widget.wheelview;
...
public class WheelView extends View {
    ...
    private DataSetObserver dataObserver = new C01532();
    ...
    WheelScroller.ScrollingListener scrollingListener = new C02061();
    ...
    /* renamed from: com.zxapp.alarmclock.wheelview.WheelView$2 */
    class C01532 extends DataSetObserver {
        C01532() {
        }
    ...
    /* renamed from: com.zxapp.alarmclock.wheelview.WheelView$1 */
    class C02061 implements WheelScroller.ScrollingListener {
        C02061() {
        }
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        this.itemsLayout.measure(MeasureSpec.makeMeasureSpec(widthSize, MeasureSpec.UNSPECIFIED), MeasureSpec.makeMeasureSpec(0, 0));
