...
public class WheelScroller {
    ...
    private Handler animationHandler = new C01522();
    private Context context;
    private GestureDetector gestureDetector;
    private SimpleOnGestureListener gestureListener = new C01511();
    ...
    /* renamed from: com.zxapp.alarmclock.wheelview.WheelScroller$1 */
    class C01511 extends SimpleOnGestureListener {
        C01511() {
        }
    ...
    /* renamed from: com.zxapp.alarmclock.wheelview.WheelScroller$2 */
    class C01522 extends Handler {
        C01522() {
        }
