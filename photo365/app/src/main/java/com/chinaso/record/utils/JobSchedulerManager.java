...
import com.chinaso.record.service.AliveJobService;
...
public class JobSchedulerManager {
    ...
    private static JobSchedulerManager sJobManager;
    ...
    public final static JobSchedulerManager getJobSchedulerInstance(Context ctxt) {
        if (sJobManager == null) {
            sJobManager = new JobSchedulerManager(ctxt);
        }
        return sJobManager;
    }
    ...
    public void startJobScheduler() {
        ...
        JobInfo.Builder builder = new JobInfo.Builder(JOB_ID, new ComponentName(sContext, AliveJobService.class));
        // 设置每5秒执行一下任务
